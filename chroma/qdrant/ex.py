...
def main():
    ...
    input_doc = Path("./data/math_test.pdf")
    ...
    doc=extract_with_preset("codeformulav2", input_doc)

    # Extract with Granite Docling model
    doc_2 =extract_with_preset("granite_docling", input_doc)
    with open("./data/math1.md","w", encoding="utf-8") as f:
        f.write(doc.export_to_markdown())
    with open("./data/math2.md","w", encoding="utf-8") as f:
        f.write(doc_2.export_to_markdown())
